          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight">
                ...
                <span className="block text-primary-600">Catch bugs faster, ship with confidence</span>
              </h1>
              <p className="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">
                {productName} helps teams automate code review with context-aware suggestions, security checks, and actionable feedback — integrated into your workflow.
              </p>
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  <li>
                    <Link href="https://github.com/Nimboo3/ai-code-reviewer" className="text-gray-600 hover:text-gray-900">
                        Documentation
                      </Link>
                  </li>
                </ul>
