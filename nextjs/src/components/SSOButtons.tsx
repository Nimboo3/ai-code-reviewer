...
const PROVIDER_CONFIGS = {
    github: {
        ...
        className: 'bg-white/[0.03] border-white/[0.08] text-white hover:bg-white/[0.06] hover:border-white/[0.12]'
    },
    google: {
        name: 'Google',
        icon: (
                ...
                {enabledProviders.map((provider) => {
                    ...
                    return (
                        <button
                            ...
                            className={`group relative flex h-11 items-center rounded-lg border px-6 transition-all duration-200 ${config.className}`}
                        >
