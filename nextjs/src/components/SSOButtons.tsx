...
const PROVIDER_CONFIGS = {
    github: {
        ...
        // GitHub uses a dark theme button for better visibility
        className: 'bg-[#24292e] border-[#30363d] text-white hover:bg-[#30363d] hover:border-[#484f58]'
    },
    google: {
        name: 'Google',
        icon: (
        ...
        <div className="mt-5">
            <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="bg-card px-3 text-gray-500">Or continue with</span>
                </div>
            </div>
                ...
                {enabledProviders.map((provider) => {
                    ...
                    return (
                        <button
                            ...
                            className={`group relative flex h-10 items-center rounded-lg border px-6 transition-all duration-200 ${config.className}`}
                        >
