    ...
    >
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
          ...
          {/* Circles - Static with CSS animation for better performance */}
          <div
            className="absolute -bottom-14 h-[100px] w-[100px] rounded-full border-t bg-accent/5 animate-[pulse_3s_ease-in-out_infinite]"
          />
          <div
            className="absolute -bottom-20 h-[145px] w-[145px] rounded-full border-t bg-accent/5 animate-[pulse_3s_ease-in-out_infinite_0.5s]"
          />
          <div
            className="absolute -bottom-[100px] h-[190px] w-[190px] rounded-full border-t bg-accent/5 animate-[pulse_3s_ease-in-out_infinite_1s]"
          />
          <div
            className="absolute -bottom-[120px] h-[235px] w-[235px] rounded-full border-t bg-accent/5 animate-[pulse_3s_ease-in-out_infinite_1.5s]"
          />
        </div>
      </div>
    </div>
